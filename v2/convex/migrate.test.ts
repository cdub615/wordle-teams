...
describe('upsertPlayers', () => {
  ...
  // caught the difference would be a lie about what the suite knows. The same
  // shape of limit as the ConvexError note in migrate.ts's deleteNamelessPlayers:
  // a real property the harness cannot observe.
  //
