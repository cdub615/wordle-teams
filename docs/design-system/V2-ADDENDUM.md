...
**Forty-three known differences from production, all deliberate. Anything else
...
`wordle-teams-kzfi`, row 48 by `wordle-teams-l23h` and row 49 by
`wordle-teams-9ahw`.** The header deliberately kept saying eighteen while that was
